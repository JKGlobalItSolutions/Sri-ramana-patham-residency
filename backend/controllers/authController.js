...
const register = async (req, res) => {
  try {
    const { firstName, lastName, email, password, phone, dateOfBirth, address, preferences } = req.body;
    ...
    try {
      await sendEmail({
        email: user.email,
        subject: 'Welcome to Sri Ramana Padam Residency - Verify Your Email',
        template: 'welcome',
        data: {
...
const forgotPassword = async (req, res) => {
  try {
    ...
    try {
      await sendEmail({
        email: user.email,
        subject: 'Sri Ramana Padam Residency - Password Reset',
